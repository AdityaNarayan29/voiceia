...
/**
 * Ferrofluid — WebGL animated background.
 *
 * Vendored from https://reactbits.dev/backgrounds/ferrofluid
 * (https://github.com/DavidHDev/react-bits — MIT licensed).
 *
 * Unmodified except for the "use client" pragma. Sized via parent
 * (the wrapping div should be position:fixed inset-0 to cover the
